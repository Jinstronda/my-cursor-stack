import { Film, UserIcon, Briefcase, Award, Edit3, Image, Share2 } from "lucide-react";
          ...
          <div className="relative flex items-center h-10">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center space-x-8">
              <Link href="/explorar">
                <Button 
                  variant="ghost" 
                  className={`text-sm font-normal px-4 h-10 ${location.startsWith('/explorar') ? 'text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                >
                  Explorar
                </Button>
              </Link>
              <Link href="/criar">
                <Button 
                  variant="ghost" 
                  className={`text-sm font-normal px-4 h-10 ${location.startsWith('/criar') ? 'text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                >
                  Criar
                </Button>
              </Link>
      ...
      <div className="flex-1 bg-background flex items-start justify-center px-6">
        <div className="text-center max-w-4xl w-full pt-20">
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-8 sm:mb-12 max-w-2xl mx-auto">
            Em breve, você poderá criar e personalizar seu portfólio profissional, 
            destacando seus trabalhos, experiências e especialidades no mundo audiovisual.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            <div className="group bg-card/50 border border-border/50 rounded-xl p-6 hover:bg-card/80 hover:border-border transition-all duration-200 hover:shadow-lg hover:shadow-primary/5">
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <h3 className="font-medium text-foreground text-sm">
                  Editor visual de portfólio
                </h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Interface intuitiva para criar e personalizar seu portfólio profissional
                </p>
              </div>
            </div>
            ...
            <div className="group bg-card/50 border border-border/50 rounded-xl p-6 hover:bg-card/80 hover:border-border transition-all duration-200 hover:shadow-lg hover:shadow-primary/5">
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <h3 className="font-medium text-foreground text-sm">
                  Galeria de trabalhos e projetos
                </h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Showcase organizado dos seus melhores trabalhos e colaborações
                </p>
              </div>
            </div>
            ...
            <div className="group bg-card/50 border border-border/50 rounded-xl p-6 hover:bg-card/80 hover:border-border transition-all duration-200 hover:shadow-lg hover:shadow-primary/5 sm:col-span-2 lg:col-span-1">
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Conecte e compartilhe seu portfólio em diferentes plataformas sociais
                </p>
              </div>
            </div>
          </div>
